  ...
  return (
    <div className="dashboard">
      <header className="page-header">
        <h1>ETH/USDT Παράγωγα (Perpetual Futures)</h1>
        <p className="last-updated">
          Ωριαία δεδομένα από OKX &middot; ζωντανά, ανά επιλεγμένη ημερομηνία
        </p>
      </header>

      <div className="date-picker-row">
        <label htmlFor="deriv-date">Ημερομηνία</label>
        <input
          id="deriv-date"
          type="date"
          value={date}
      ...
      {candles.length > 0 && (
        <>
          ...
          {oi.length === 0 && (
            <p className="status-message">Δεν υπάρχουν δεδομένα Open Interest για αυτή την ημερομηνία (το OKX κρατά περιορισμένο ιστορικό).</p>
          )}
